...
async function main() {
  ...
  test('extractBookFields pulls all 8 raw fields from a real book page', () => {
    ...
    const fields = extractBookFields(html, { productUrl: 'https://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html', sourcePage: 1, fetchedAt: '2026-08-25T00:00:00.000Z' });
    ...
    assert.strictEqual(fields.source_page, 1);
  ...
  test('extractBookFields degrades to nulls (never throws) on a broken page', () => {
    ...
    const fields = extractBookFields(html, { productUrl: 'https://books.toscrape.com/catalogue/broken/index.html', sourcePage: 1, fetchedAt: '2026-08-25T00:00:00.000Z' });
  ...
  test('validateCollection flags duplicate product_url', () => {
    const base = normalizeRecord({
      ...
      source_page: 1, fetched_at: new Date().toISOString(),
    });
  ...
  await testAsync('scrapeAllBooks continues past a 404 and a malformed page, still returns the good ones', async () => {
    ...
    const bookRefs = [
      { url: 'https://books.toscrape.com/catalogue/good-1/index.html', sourcePage: 1 },
      { url: 'https://books.toscrape.com/catalogue/missing/index.html', sourcePage: 1 },
      { url: 'https://books.toscrape.com/catalogue/broken/index.html', sourcePage: 2 },
      { url: 'https://books.toscrape.com/catalogue/good-2/index.html', sourcePage: 2 },
    ];
